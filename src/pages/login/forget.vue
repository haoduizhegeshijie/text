  ...
  <view class="content">
    <view class="list">
      ...
      <view class="list-call">
        ...
        <image class="img" :src="showPassword?'/static/image/shilu-login/op.png':'/static/image/shilu-login/cl.png'" @tap="display"></image>
      </view>
      <view class="list-call">
        <image class="img" src="/static/image/shilu-login/3.png"></image>
